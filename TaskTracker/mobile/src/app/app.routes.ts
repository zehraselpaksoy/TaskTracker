...
export const routes: Routes = [
  ...
  },
  {
    ...
    loadComponent: () =>
      import(
        './pages/team-task-list/team-task-list.page'
      ).then(
  ...
  },
  {
    ...
    loadComponent: () =>
      import(
        './pages/team-summary/team-summary.page'
      ).then(
        (m) => m.TeamSummaryPage
      )
  },
  {
    ...
    loadComponent: () =>
      import(
        './pages/team-calendar/team-calendar.page'
      ).then(
  ...
  },
  {
    ...
    loadComponent: () =>
      import(
        './pages/task-detail/task-detail.page'
      ).then(
        (m) => m.TaskDetailPage
      )
  },
  ...
  },
  {
    ...
    loadComponent: () =>
      import(
        './pages/team-invitation/team-invitation.page'
      ).then(
        (m) => m.TeamInvitationPage
      )
  }
];